...
{
  Data10years_df <-   as.tibble(DATESR(start_D = startDay, end_D = endDay, Number_year =  numberYear, STATION =station, 5,2,1)$LTNewtest_df)
  head(Data10years_df)
  start_D2 <- as.Date(startDay) - years(numberYear)
  print(start_D2)
  
  dataperiod_df <- as.tibble(DATESR(start_D = startDay, end_D = endDay, Number_year =  numberYear, STATION =station, 5,2,1)$Newtest_df)
